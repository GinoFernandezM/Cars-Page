    ...
    <>
      <Transition appear show={isOpen} as={Fragment}>
        <Dialog as='div' className='relative z-10' onClose={closeModal}>
          ...
          >
            <Dialog.Panel className='relative w-full max-w-lg max-h-[90vh] bg-white overflow-y-auto transform rounded-2xl text-left shadow-xl p-6 transition-all flex flex-col gap-5'>
